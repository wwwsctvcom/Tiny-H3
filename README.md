...
The largest configuration trained end to end on one RTX 5090: **Tiny-H3-XL (140M DiT) on 4,096 procedural clips** (8x the default set), 6,000 steps in ~26 min with batched forwards (peak VRAM 2.4 GB). Early stopping scored 256 held-out clips every 250 steps:
