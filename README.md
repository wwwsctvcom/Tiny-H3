...
*216x216-ish detail note: cinematic colour, light and layout transfer; fine detail is limited by
the 256x256 canvas and the 386M size — scale `--size`/preset up for more.*
